(function($){
	...
	$(function () {
		...
		$('.deploy__preview--controls #preview__button--desktop').click(function () {
			$('.deploy__preview--controls button.active').removeClass('active');
		...
		$('.deploy__preview--controls #preview__button--tablet').click(function () {
			$('.deploy__preview--controls button.active').removeClass('active');
			$(this).addClass('active');
			if (intModo == 'D') {
				NiceScrollEnable();
		...
		$('.deploy__preview--controls #preview__button--mobile').click(function () {
			$('.deploy__preview--controls button.active').removeClass('active');
			$(this).addClass('active');
			if (intModo == 'D') {
				NiceScrollEnable();
		...
		window.SetSize = function () {
			if (intModo == 'D') {
				$('#frPrev').css({ left: 0, top: BarHeight, height: $(window).height() - BarHeight, width: '100vw', marginLeft: 0, marginTop: 0 });
			}
			if (intModo == 'T') {
				if (strTModo == 'R') {
