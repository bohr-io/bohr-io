<template>
  <svg :width="sizePx" :height="sizePx" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
      d="M9 3C9 3.55228 8.55228 4 8 4C7.44772 4 7 3.55228 7 3C7 2.44772 7.44772 2 8 2C8.55228 2 9 2.44772 9 3ZM9 8C9 8.55228 8.55228 9 8 9C7.44772 9 7 8.55228 7 8C7 7.44772 7.44772 7 8 7C8.55228 7 9 7.44772 9 8ZM8 14C8.55228 14 9 13.5523 9 13C9 12.4477 8.55228 12 8 12C7.44772 12 7 12.4477 7 13C7 13.5523 7.44772 14 8 14Z"
...
export default defineComponent({
  ...
  data() {
    return {
      gradientId: `vertical-dots-icon-gradient-${Math.random().toString().slice(2)}`,
    };
  },
})
</script>
