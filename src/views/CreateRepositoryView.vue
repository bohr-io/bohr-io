...
export default defineComponent({
  ...
  methods: {
    ...
    handleScopeErrorRedirect() {
      ...
      window.location.href = `https://github.com/login/oauth/authorize?client_id=${clientId}&scope=repo,read:user,read:org,user:email;&redirect_uri=https://${window.location.hostname}/signin?bypass=1&state=|${window.location.href}`;
    },
  },
});
</script>
